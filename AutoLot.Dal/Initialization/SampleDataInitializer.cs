...
public static class SampleDataInitializer
{
    ...
    /// <summary>
    /// Works very well when you are using a local database (e.g., in a Docker container, on your local drive, etc.)
    /// If you are using SQL Azure, use the ClearData() method instead
    /// </summary>
